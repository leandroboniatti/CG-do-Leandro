...
const GLchar* fragmentShaderSource = "#version 400\n"	//Códifo fonte do Fragment Shader (em GLSL - Graphics Library Shading Language)
...
int main() {
	...
	while (!glfwWindowShouldClose(window))	{
		...
		glLineWidth(10);	// o espessura padrão da linha é 1 pixel - altera para....
		glPointSize(20);	// o tamanho padrão do ponto é 1 pixel - altera para....
